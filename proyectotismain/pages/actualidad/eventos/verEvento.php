...
if (isset($_GET['id']) && is_numeric($_GET['id'])) {
    ...
    $evento = obtenerEventoPorId($connection, $id);
...
<!--AQUI SE VEN Los eventos. -->
<div class="breadcrumb-wrap">
    <div class="container">
        <ul class="breadcrumb">
            <li class="breadcrumb-item"><a href="index.php?p=home">Inicio</a></li>
            <li class="breadcrumb-item"><a href="index.php?p=actualidad/eventos/eventos">Eventos</a></li>
        ...
        <div class="row">
            <div class="col-lg-8">
                <div class="sn-container">
                    <div class="sn-img">
                        <img src="pages/admin/eventos_adm/imagenes/<?php echo $evento['imagen']; ?>">
                    </div>
                    <div class="sn-content">
                        <h1 class="sn-title"><?php echo $evento['titulo'] ?></h1>
            ...
            <div class="col-lg-4">
                <div class="sidebar">
                    ...
                    <?php
                        if ($email_usuario && !$accion) {
                        ?>
                            <div class="follow-event">
                                <form method="POST" action="">
                                    <input type="submit" name="seguir_evento" class="btn-outline-success" value="Seguir Evento">
                                </form>
                            </div>
                        <?php
                        }

                        if ($email_usuario && isset($_POST['seguir_evento'])) {
                            $email_usuario_actual = obtenerEmailUsuarioActual();
                            ...
                            <div class="news-list">
                                ...
                                <?php
                                    ...
                                    if (isset($_POST['comentar']) || isset($_POST['reply'])) {
                                        ...
                                        if (!$email_usuario || !$id_usuario || !$id_evento) {
                                            echo "Error: El usuario no está autenticado, no se encontró el ID del usuario o el ID del evento.";
                                        } else {
                                            ...
                                            try {
                                                ...
                                                $query_comentario = mysqli_query($connection, "INSERT INTO comentarios (comentario, id_users, id_evento, fecha) VALUES ('$comentario', '$id_usuario', '$id_evento', NOW())");
                                ...
                                <div id="container">
                                    <ul id="comments">
                                        <?php
            $comentarios = mysqli_query($connection, "SELECT * FROM comentarios WHERE reply = 0 AND id_evento = '$id' ORDER BY id DESC");
