...
<main class="container mt-5">
    ...
    <div class="form-group">
        ...
        <input type="text" id="mision" name="mision" class="form-control" rows="5" placeholder="<?php echo $mision; ?>" value="<?php echo $mision; ?>">
    </div>
    <div class="form-group">
        <label for="vision">Visión:</label>
        <input type="text" id="vision" name="vision" class="form-control" rows="5" placeholder="<?php echo $vision; ?>" value="<?php echo $vision; ?>">
    </div>
