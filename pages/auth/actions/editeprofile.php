            ...
            <div class="col">
                <form action="index.php?p=auth/actions/updateprofile" method="POST">
                    ...
                    <div class="input-group mb-3">
                        ...
                        <input type="text" name="nombre" class="form-control" placeholder="" value =" <?php echo $nombre ?>" required>
                    </div>
                    <div class="input-group mb-3">
                        <span class="input-group-text" id="basic-addon1">Apellido</span>
                        <input type="text" name="apellido" class="form-control" placeholder="" value =" <?php echo $apellido ?>" required>
                    </div>
                    <div class="input-group mb-3">
