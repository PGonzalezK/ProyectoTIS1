        ...
        <div class="collapse navbar-collapse" id="navbarTogglerDemo02">
            ...
            ?>
                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                    <li class="nav-item">
                        <a class="nav-link <?php echo ($pagina == 'home') ? 'active' : null ?>" aria-current="page" href="../index.php">Inicio</a>
                    </li>
                    <li class="nav-item">
                    ...
                    <li class="nav-item">
                        <a class="nav-link <?php echo (strpos($pagina, 'noticias') !== false) ? 'active' : null ?>" href="admin/index.php">Eventos</a>
                    </li>
                    <li class="nav-item">
                ...
                <div class="d-flex">
                    ...
                    <a href="../cerrarSesion.php" class="btn btn-sm btn-outline-danger">Cerrar Sesión</a>
                </div>
            ...
            ?>
                ...
                <div class="d-flex">
                    <a href="login.php" class="btn btn-sm btn-outline-primary me-2">Iniciar Sesión</a>
